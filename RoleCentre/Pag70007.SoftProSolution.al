...
page 70007 "SoftPro Solutions Role Center"
{
    // CurrPage."Help And Setup List".ShowFeatured;

    Caption = 'SoftPro Solutions';
    PageType = RoleCenter;
    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            //------------------- SoftPro Solutions Customized Pages Add Start ---------------------------------

            group("SoftPro Expert Pages")
            {

                Caption = 'SoftPro Solutions';
                Image = FiledPosted;
                ToolTip = 'View the SoftPro Expert Customized Pages';

                action("Lorry Master List")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Lorry Master List';
                    RunObject = Page "Lorry Master List";
                    ToolTip = 'Open the Lorry Master List';
                }
                action(MraApiSetup)
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'MRA API Setup';
                    RunObject = Page MraApiSetup;
                    ToolTip = 'Open the MRA API Setup';
                }
                ...
                action("E-Invoice")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'E-Invoice';
                    RunObject = Page "E-Invoice";
                    ToolTip = 'Open the E-Invoice';
                }
                action("E-Invoice History")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'E-Invoice History';
                    RunObject = Page "E-Invoice History";
                    ToolTip = 'Open the E-Invoice History';
                }
            ...
            //------------------- SoftPro Expert Customized Pages Add Closed ---------------------------------        }
